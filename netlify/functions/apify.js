...
exports.handler = async function(event) {
  ...
  try {
    ...
    if (action === 'draftOutreach') {
      ...
      var SIG = 'Signature block, exactly these lines: "Sunil Shilimkar"; "Business Head | SecVision Technologies LLP | Pune | India"; then "sunil@secvisiontech.com | secvisiontech.com" where secvisiontech.com is an HTML hyperlink to https://secvisiontech.com/ (colored #0E7490). Nothing after these lines - no separate Pune, India line.';
