  ...
  try {
    ...
    if (action === 'draftOutreach') {
      ...
      try {
        ...
        return { statusCode: 200, headers: hdrs, body: JSON.stringify({ subject: subj, html: htmlB, body: plainB }) };
