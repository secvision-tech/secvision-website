...
exports.handler = async function(event) {
  ...
  try {
    ...
    if (action === 'draftOutreach') {
      ...
      var SIG = 'Signature block: name, then "Business Head, SecVision Technologies LLP", then exactly "sunil@secvisiontech.com | secvisiontech.com", then "Pune, India".';
