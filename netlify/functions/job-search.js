...
function extractExp(job) {
  ...
  var p3 = /(?:minimum|at\s*least|requires?)\s*(\d+)\+?\s*(?:years?|yrs?)\s*(?:of\s*)?(?:[\w\-\u2010\u2011\s]*)?(?:experience|expertise)\s*(?:in|with|using)?\s*([\w\s,\/&\-]+?)(?:\.|;|,|\n|$)/gi;
  ...
  var p6 = /[\u2022\-\*]\s*(\d+)\+?\s*(?:years?|yrs?)\s*(?:of\s*)?(?:[\w\s]*?)(?:experience|expertise|background)\s*(?:in|with|on|across)?\s*([\w\s,\/&\-\u2010\u2013()]+?)(?:\.|;|\n|$)/gi;
